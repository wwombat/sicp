...
(define (midpoint-segment line)
  (let ((a (start-segment line))
        (b (end-segment   line))
        (get-avg (lambda (a b func)
                   (avg (func a) (func b)))))
    (make-point (get-avg a b x-point) (get-avg a b y-point)))) 

(define 1-2 (make-point 1 2)) 
(define 3-6 (make-point 3 6)) 
(define my-line (make-segment 1-2 3-6))  

(midpoint-segment my-line) 
